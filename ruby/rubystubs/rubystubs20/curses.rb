...
module Curses
    ...
    class Pad < Window
        ...
        def subpad(height, width, begin_x, begin_y)
            #This is a stub, used for indexing
        end
        ...
        def refresh(pad_minrow, pad_mincol, screen_minrow, screen_mincol, screen_maxrow, screen_maxcol)
            #This is a stub, used for indexing
        end
        ...
        # +screen_maxrow+, +screen_maxcol+ define the edges of the rectangle to be
        # displayed on the screen.
        def noutrefresh(pad_minrow, pad_mincol, screen_minrow, screen_mincol, screen_maxrow, screen_maxcol)
            #This is a stub, used for indexing
        end
    end
    # == Description
