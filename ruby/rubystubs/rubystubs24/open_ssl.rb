...
module OpenSSL
    ...
    OPENSSL_LIBRARY_VERSION = nil #value is unknown, used for indexing.
    ...
    # installation.
    module ExtConfig
        HAVE_TLSEXT_HOST_NAME = nil #value is unknown, used for indexing.
        TLS_DH_anon_WITH_AES_256_GCM_SHA384 = nil #value is unknown, used for indexing.
        OPENSSL_NO_SOCK = nil #value is unknown, used for indexing.
    end
    class HMAC
    ...
    module OCSP
        ...
        RESPONSE_STATUS_INTERNALERROR = nil #value is unknown, used for indexing.
        # Illegal confirmation request   
        RESPONSE_STATUS_MALFORMEDREQUEST = nil #value is unknown, used for indexing.
        # The certificate was revoked for an unknown reason   
        REVOKED_STATUS_NOSTATUS = nil #value is unknown, used for indexing.
        # You must sign the request and resubmit   
        RESPONSE_STATUS_SIGREQUIRED = nil #value is unknown, used for indexing.
        # Response has valid confirmations   
        RESPONSE_STATUS_SUCCESSFUL = nil #value is unknown, used for indexing.
        # Try again later   
        RESPONSE_STATUS_TRYLATER = nil #value is unknown, used for indexing.
        # The certificate subject's name or other information changed   
        REVOKED_STATUS_AFFILIATIONCHANGED = nil #value is unknown, used for indexing.
        # This CA certificate was revoked due to a key compromise   
        REVOKED_STATUS_CACOMPROMISE = nil #value is unknown, used for indexing.
        # The certificate is on hold   
        REVOKED_STATUS_CERTIFICATEHOLD = nil #value is unknown, used for indexing.
        # The certificate is no longer needed   
        REVOKED_STATUS_CESSATIONOFOPERATION = nil #value is unknown, used for indexing.
        # The certificate was revoked due to a key compromise   
        REVOKED_STATUS_KEYCOMPROMISE = nil #value is unknown, used for indexing.
        # The certificate was previously on hold and should now be removed from
        # the CRL   
        REVOKED_STATUS_REMOVEFROMCRL = nil #value is unknown, used for indexing.
        # The certificate was superseded by a new certificate   
        REVOKED_STATUS_SUPERSEDED = nil #value is unknown, used for indexing.
        # Your request is unauthorized.   
        RESPONSE_STATUS_UNAUTHORIZED = nil #value is unknown, used for indexing.
        # The certificate was revoked for an unspecified reason   
        REVOKED_STATUS_UNSPECIFIED = nil #value is unknown, used for indexing.
        # Do not include certificates in the response   
        NOCERTS = nil #value is unknown, used for indexing.
        # Do not search certificates contained in the response for a signer   
        NOINTERN = nil #value is unknown, used for indexing.
        # Do not check the signature on the response   
        NOSIGS = nil #value is unknown, used for indexing.
        # Do not verify the certificate chain on the response   
        NOCHAIN = nil #value is unknown, used for indexing.
        # Do not verify the response at all   
        NOVERIFY = nil #value is unknown, used for indexing.
        # Do not check trust   
        NOEXPLICIT = nil #value is unknown, used for indexing.
        # (This flag is not used by OpenSSL 1.0.1g)   
        NOCASIGN = nil #value is unknown, used for indexing.
        # (This flag is not used by OpenSSL 1.0.1g)   
        NODELEGATED = nil #value is unknown, used for indexing.
        # Do not make additional signing certificate checks   
        NOCHECKS = nil #value is unknown, used for indexing.
        # Do not verify additional certificates   
        TRUSTOTHER = nil #value is unknown, used for indexing.
        # Identify the response by signing the certificate key ID   
        RESPID_KEY = nil #value is unknown, used for indexing.
        # Do not include producedAt time in response   
        NOTIME = nil #value is unknown, used for indexing.
        ...
        V_CERTSTATUS_GOOD = nil #value is unknown, used for indexing.
        # Indicates the certificate has been revoked either permanently or
        # temporarily (on hold).   
        V_CERTSTATUS_REVOKED = nil #value is unknown, used for indexing.
        # Indicates the responder does not know about the certificate being
        # requested.   
        V_CERTSTATUS_UNKNOWN = nil #value is unknown, used for indexing.
        # The responder ID is based on the key name.   
        V_RESPID_NAME = nil #value is unknown, used for indexing.
        # The responder ID is based on the public key.   
        V_RESPID_KEY = nil #value is unknown, used for indexing.
        ...
        class BasicResponse
            ...
            def add_status(certificate_id, status, reason, revocation_time, this_update, next_update, extensions)
                #This is a stub, used for indexing
            end
            ...
            def find_response(certificate_id)
                #This is a stub, used for indexing
            end
            ...
            def sign(cert, key, certs = nil, flags = 0, digest = nil)
                #This is a stub, used for indexing
            end
            ...
            def verify(certificates, store, flags = 0)
                #This is a stub, used for indexing
            end
        ...
        class Request
            ...
            def check_nonce(response)
                #This is a stub, used for indexing
            end
            # request.add_certid(certificate_id) -> request
            # 
            # Adds +certificate_id+ to the request.
            def add_certid(certificate_id)
                #This is a stub, used for indexing
            end
        ...
        class Response
            ...
            def self.create(status, basic_response = nil)
                #This is a stub, used for indexing
            end
        ...
        class SingleResponse
            ...
            def check_validity(nsec = 0, maxsec = -1)
                #This is a stub, used for indexing
            end
    ...
    module Random
        ...
        def self.random_add(p1, p2)
            #This is a stub, used for indexing
        end
        # load_random_file(filename) -> true
        # 
        # Reads bytes from +filename+ and adds them to the PRNG.
        def self.load_random_file(filename)
            #This is a stub, used for indexing
        end
        ...
        # later session.
        def self.write_random_file(filename)
            #This is a stub, used for indexing
        end
        ...
        # PRNG.
        def self.egd_bytes(filename, length)
            #This is a stub, used for indexing
        end
        # status? => true | false
        # 
